                ...
                { content && 
                    ...
                    >
                        <motion.div 
                            ...
                            className="max-w-[95vw] md:max-w-2xl w-full bg-gradient-to-r from-sky-50 via-fuchsia-50 to-sky-100 m-4 drop-shadow-lg opacity-100 p-4 pb-6 rounded-2xl aanimate-bounce-up-in"
                        >
